...
const LeftSection = () => {
  return (
    <div className="absolute left-0 flex h-full max-w-screen-xl flex-col text-black items-center justify-around bg-transparent py-8 sm:px-0 md:mx-auto md:px-4">
...
const RightSection = () => {
  return (
    <div className="social-media-tab absolute right-0 mx-5 text-black flex h-full max-w-screen-xl flex-col items-center justify-end bg-transparent px-4 py-20 text-2xl">
      {/* Enlaces a redes sociales */}
      <div className="flex h-[15%] flex-col items-center justify-between">
        <a
          href="https://www.instagram.com/splinetool/"
          target="_blank"
        ...
        <a
          href="https://www.facebook.com/splinetool/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <AiOutlineFacebook />
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="animacion-1 relative rounded-full px-3 py-1 text-sm leading-6 bg-white text-gray-600 ring-1 ring-gray-900/10">
          ...
          <div className="text-center">
            ...
            <p className="animacion-3 mt-6 text-lg leading-8 text-gray-600">
              Aplicamos una metodología adaptada a las necesidades de tu
              organización. Trabajamos en conjunto para compensar las
              debilidades y construir sobre las fortalezas.
            </p>
